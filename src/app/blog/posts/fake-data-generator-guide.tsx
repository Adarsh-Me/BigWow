  ...
  return (
    <div>
      <p>
        ...
        <Link href="/tools/fake-data">BigWow Fake Data Generator</Link> does it for free, locally,
      ...
      <h2>What the BigWow Fake Data Generator Produces</h2>
      <p>
...
// Paste generated JSON directly from BigWow:
const fakeUsers = [
...
export const WithData: StoryObj<typeof UserTable> = {
  args: { users: fakeUsers },
      ...
      <pre style={{background: "rgba(128,128,128,0.08)", border: "1px solid rgba(128,128,128,0.2)", borderRadius: "10px", padding: "16px", overflowX: "auto", fontSize: "13px", lineHeight: "1.6"}}><code>{`// tests/fixtures/users.json — generated by BigWow, committed to version control
  ...
  it.each(users.slice(0, 10))('creates user with valid data (%s)', async (user) => {
    ...
    expect(response.body.email).toBe(user.email);
        ...
        <table style={{width: "100%", borderCollapse: "collapse", fontSize: "14px"}}>
          <thead>
            <tr style={{background: "rgba(34,197,94,0.08)"}}>
              ...
              <th style={{padding: "12px 16px", textAlign: "center", borderBottom: "2px solid rgba(34,197,94,0.25)", fontWeight: "700"}}>BigWow</th>
      ...
      <p>
        ...
        common case — generating realistic JSON or CSV for user records — BigWow requires no
      ...
      <p>
        ...
        output data itself are never transmitted to any server. BigWow has no backend component
      ...
      <p>
        Open the <Link href="/tools/fake-data">BigWow Fake Data Generator</Link>, select your fields,
